...
import { AddressCard, AddressInfo, FormContainer, InputStyles, Wrapper } from "./styles"
                ...
                <form>
                    <FormContainer>
                        ...
                        <div>
                            ...
                            <InputStyles type='text' width={70} name='Complemento' placeholder="Complemento" /><br />
                            <InputStyles type='text' width={30} name='Bairro' autoComplete="on" placeholder="Bairro" required />
                            <InputStyles type="text" width={40} name="Cidade" autoComplete="on" placeholder="Cidade" required />
                            <InputStyles type="text" width={17} name="UF" autoComplete="on" placeholder="UF" required />
                        </div>
